  ...
  >
    <div className="flex items-center justify-between mb-4">
      ...
      <div className="text-right">
        <Heading level={2} className="text-2xl font-bold text-white">{value}</Heading>
        {subValue && <Paragraph className="text-sm text-gray-400">{subValue}</Paragraph>}
      </div>
    </div>
    <Paragraph className="text-gray-300 font-medium">{label}</Paragraph>
  </MotionDiv>
);
